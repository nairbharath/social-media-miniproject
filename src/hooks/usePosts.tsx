import { doc, deleteDoc, collection, writeBatch, getDocs, query, where } from "firebase/firestore";
...
const usePosts = () => {
  ...
  const onSelectPost = (post: Post) => {
    ...
    router.push(`/q/${post.communityId}/comments/${post.id}`);
  };
  ...
  // get votes even after refreshing
